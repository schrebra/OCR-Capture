...
# Load system icon extraction function
Add-Type @"
using System;
...
Function FormUI {
  ...
  # Extract magnifier icon from Windows system file (index 22)
  $iconHandle = [SystemIcons]::ExtractIcon([IntPtr]::Zero, "$env:SystemRoot\System32\imageres.dll", 14)
